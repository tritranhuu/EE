...
def token_arg(s):
    return [(t, a) for t, a in st.split(':') for st in s.split()]
...
#     self.argument_tag_field = Field(unk_token=None)
#     # self.argument_nested_field = 
...
print(token_arg('Adjudicator-Arg:T2 Defendant-Arg:T3'))