...
class CNN(nn.Module):
  ...
  def __init__(self, 
    ...
    self.emb_to_cnn_input = self.get_linear_layer(embedding_dim + char_emb_dim*char_cnn_filter_num + pos_emb_dim, cnn_out_chanel)
    ...
    self.fc = self.get_linear_layer(cnn_out_chanel*len(cnn_kernels), output_dim)
