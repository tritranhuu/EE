...
parser.add_argument("--train_path", type=str, default="./data/train/",help="train dir")
parser.add_argument("--dev_path", type=str, default="./data/dev/",help="test dir")
parser.add_argument("--test_path", type=str, default="./data/test/",help="test dir")
